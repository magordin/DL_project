...
#BSUB -W 08:00
#BSUB -o /work3/s252608/DL_project/logs/vae_fix_%J.out
#BSUB -e /work3/s252608/DL_project/logs/vae_fix_%J.err
...
for REPR in ${REPRESENTATIONS}; do
  ...
  REPR_FILE="${REPR_DIR}/${DATASET_NAME}_${REPR}_dim${LATENT_DIM}_fix.npy"
